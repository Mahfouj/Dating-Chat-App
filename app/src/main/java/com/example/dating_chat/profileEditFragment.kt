...
import coil.load
import com.example.dating_chat.databinding.FragmentProfileEditBinding
...
class profileEditFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        requireArguments().getString(profileFragment.USERID)?.let {
            userId =it
            getUserByID(it)
        }
                ...
                userDb.child(DBNODES.USER).child(userId).updateChildren(userMap)
                    .addOnCompleteListener {
                        ...
                        if (it.isSuccessful) {
                            ...
                            Toast.makeText(requireContext(), "Update Profile!", Toast.LENGTH_SHORT)
                                .show()
    ...
    private fun pickProfileImage() {
        ...
        ImagePicker.with(this)
            ...
            .compress(600)			//Final image size will be less than 1 MB(Optional)
