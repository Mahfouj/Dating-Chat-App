...
import com.example.dating_chat.databinding.FragmentChatProfileBinding
...
class chatProfileFragment : Fragment() {
       ...
       lateinit var  binding: FragmentChatProfileBinding
             ...
             object : ValueEventListener {
                 ...
                 override fun onDataChange(snapshot: DataSnapshot) {
                     ...
                     snapshot.getValue(User::class.java)?.let {
                       ...
                       Glide.with(requireContext()).load(it.profileImage).into(binding.profileImage)
    ...
    private fun messageToShow() {
        ...
        chatDb.child(DBNODES.CHATS).addValueEventListener(object :ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val adapter = TextAdapter(userIDSelf,chatList)
